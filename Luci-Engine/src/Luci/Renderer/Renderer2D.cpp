...
namespace Luci {
	...
	void Renderer2D::DrawQuad(const glm::vec2& position, const glm::vec2& scale, const Ref<Texture2D> texture, const glm::vec4& tint) {
		DrawQuad({ position.x, position.y, 0.0f }, scale, texture, tint);
	}
